...
// the output is the chance that eating the fruit will kill you
// a violet fruit with not spots is expected to be extremely safe
// a red fruit with a lot of spots is expected to be fatal
...
console.log(nn.calculateCost([0]));